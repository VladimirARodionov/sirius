<template>
  <Menu>
    <DirectoryDetail :object="data.currentObject" :title="this.$t('Edit address')" name="editAddress" :errorMessage="data.errorMessage" :on-clicked="editObject" :names="names" :onSelect="onSelect"/>
  </Menu>
</template>
