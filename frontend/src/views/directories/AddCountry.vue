<template>
  <Menu>
    <DirectoryDetail :object="data.currentObject" :title="this.$t('Add country')" :errorMessage="data.errorMessage" :on-clicked="addObject" :names="names"/>
  </Menu>
</template>
...
export default {
  ...
  methods: {
    ...
    addObject: function () {
      onPostSingle('/api/country/', this.data, this.getObject)
    }
  },
  components: {
    Menu,
