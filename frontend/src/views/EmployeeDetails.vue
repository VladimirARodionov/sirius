<template>
  <Menu>
    <UserDetail :title="$t('Employee details')" api="/api/userdetail/" :names="names"/>
  </Menu>
</template>
  ...
  data () {
    return {
      names: [
        ...
        { text: 'Unit', type: 'multi-selector-tree', name: 'units', routerName: 'units', api: '/api/unit/', value: 'name', tree_name: 'unit' },
