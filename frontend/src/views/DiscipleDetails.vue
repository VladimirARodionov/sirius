<template>
  <Menu>
    <UserDetail :title="$t('Disciple details')" api="/api/userdetail/" :names="names"/>
  </Menu>
</template>
  ...
  data () {
    return {
      names: [
        ...
        { text: 'Faculty', type: 'multi-selector-tree', name: 'faculty', routerName: 'faculties', api: '/api/faculty/', updateApi: '/api/userfaculty/update/', value: 'name', tree_name: 'faculties' },
