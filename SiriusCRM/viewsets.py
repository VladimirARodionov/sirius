...
class LeadViewSet(HasRoleMixin, CountModelMixin, viewsets.ModelViewSet):
    ...
    filter_backends = (filters.SearchFilter, filters.OrderingFilter,)
    pagination_class = StandardResultsSetPagination
    search_fields = ('id', 'date_added', 'first_name', 'last_name', 'middle_name', 'email', 'mobile')
    ordering_fields = ('id', 'date_added', 'first_name', 'last_name', 'middle_name', 'email', 'mobile', 'status', 'source', 'consultant')
